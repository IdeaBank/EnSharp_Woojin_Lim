...
namespace Library
{
    public class AdminRemoveUserViewerClass: Viewer.ViewerClass
    {
        public AdminRemoveUserViewerClass(Data data, DataManager dataManager, InputFromUser inputFromUser): base(data, dataManager, inputFromUser)
        {
        }
